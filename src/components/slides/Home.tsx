    ...
    <>
      ...
      flex-col justify-center items-center gap-4 px-5 '>
        <Image
          ...
          width={188}
          height={30}
          className='h-auto w-auto mx-auto md:w-80 md:h-20 lg:h-16'
        />
        <h1 className="text-center mb-3 lg:text-lg">[ Frontend Engineer ]</h1>
        <div className="flex justify-center items-center gap-4 flex-wrap md:w-60">
          ...
          <Link href={'https://www.credly.com/users/andres-roldan-wilches/badges'} target='_blank'>
            <SiCredly size={30} className='md:w-8 md:h-8 lg:w-10 lg:h-10' />
          </Link>
